...
@section('title', 'Edit Articles - Admin')
{{-- content --}}
@section('content')
        ...
        <div class="mt-3">
            ...
            <form action="{{ url('article/' . $article->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="desc" id="myeditor" cols="30" rows="10" name="desc" class="form-control">{{ old('desc', $article->desc) }}
                        </textarea>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            value="{{asset('storage/back/pdf' . $article->pdf)}}">
                        </div>
                    </div>
                </div>
                <div class="float-end">
